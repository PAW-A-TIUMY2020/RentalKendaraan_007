...
namespace RentalKendaraan_007.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdPeminjaman"] = new SelectList(_context.Peminjaman, "IdPeminjamaan", "IdPeminjamaan");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPengembalian,TglPengembalian,IdPeminjaman,IdKondisi,Denda")] Pengembalian pengembalian)
        {
            ...
            ViewData["IdPeminjaman"] = new SelectList(_context.Peminjaman, "IdPeminjamaan", "IdPeminjamaan", pengembalian.IdPeminjaman);
            return View(pengembalian);
        }
