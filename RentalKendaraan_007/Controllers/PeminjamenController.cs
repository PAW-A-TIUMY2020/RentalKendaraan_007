...
using RentalKendaraan_007.Models;

namespace RentalKendaraan_007.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjamaan,TglPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPeminjamaan,TglPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
        ...
        {
            return _context.Peminjaman.Any(e => e.IdPeminjamaan == id);
        }
    }
}
